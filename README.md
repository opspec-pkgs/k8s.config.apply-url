[![Build Status](https://github.com/opspec-pkgs/k8s.config.apply-url/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/k8s.config.apply-url/actions?query=workflow%3Abuild+branch%3Amain)
