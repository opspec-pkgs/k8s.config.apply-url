[![build](https://github.com/opspec-pkgs/k8s.config.apply-url/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/k8s.config.apply-url/actions/workflows/build.yml)
